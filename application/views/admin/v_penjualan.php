...
<div id="wrapper">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <table>
                <tr>
                    <th><a href="#" data-toggle="modal" data-target="#largeModal" class="pull-left">Cari Produk!</a></th>
                </tr>
                <tr>
            ...
            <table class="table table-bordered table-condensed" style="font-size:11px;margin-top:10px;">
                ...
                <tbody>
                    ...
                    <tr>
                         ...
                         <td style="text-align:center;"><a href="<?php echo base_url().'admin/penjualan/remove/'.$items['rowid'];?>" class="btn btn-danger btn-xs"><span class="fa fa-close"></span>X</a>
                   <a href="<?php echo base_url().'admin/penjualan/remove/'.$items['rowid'];?>" class="btn btn-success btn-xs"><span class="fa fa-close"></span> +</a>
					<a href="<?php echo base_url().'admin/penjualan/remove/'.$items['rowid'];?>" class="btn btn-warning btn-xs"><span class="fa fa-close"></span> -</a></td>
                    </tr>
                    <?php $i++; ?>
                    <?php endforeach; ?>
                </tbody>
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p style="text-align:center;">Copyright &copy; <?php echo '2019';?> by TukangKomputer</p>
                </div>
            </div>
            <!-- /.row -->
        </footer>
    ...
    <script src="<?php echo base_url().'assets/bootstrap/dist/js/bootstrap-select.min.js'?>"></script>
    <script src="<?php echo base_url().'assets/bootstrap/js/bootstrap.min.js'?>"></script>
    <script src="<?php echo base_url().'assets/bootstrap/dataTables/dataTables.bootstrap4.min.js'?>"></script>
    <script src="<?php echo base_url().'assets/bootstrap/dataTables/jquery.dataTables.min.js'?>"></script>
    <script src="<?php echo base_url().'assets/bootstrap/js/jquery.price_format.min.js'?>"></script>
